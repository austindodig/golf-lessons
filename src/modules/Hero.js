...
export function mountHero(stageEl, heroSection) {
  ...
  const key = new THREE.DirectionalLight(new THREE.Color('#fff1dc'), 1.6); key.position.set(1.5, 1.2, 2.2); scene.add(key);
  ...
  club.userData.head.traverse((o) => { if (!o.material) return; if (o.material.metalness === 1) o.material.roughness = 0.55; if (o.material.clearcoat) { o.material.clearcoat = 0.5; o.material.clearcoatRoughness = 0.45; } });
